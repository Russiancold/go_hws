...
var game0cases = [][]gameCase{
	[]gameCase{
		...
		{4, "осмотреться", "ты в своей комнате, на столе: ключи, конспекты, на стуле: рюкзак, можно пройти - коридор"},
		...
		{11, "идти улица", "на улице весна, можно пройти - коридор"},
	},
	...
	[]gameCase{
		...
		{7, "осмотреться", "ты в своей комнате, на столе: ключи, конспекты, на стуле: рюкзак, можно пройти - коридор"},
		{8, "взять ключи", "некуда класть"}, // надо взять рюкзак сначала
		{9, "надеть рюкзак", "вы надели: рюкзак"},
		{10, "осмотреться", "ты в своей комнате, на столе: ключи, конспекты, можно пройти - коридор"}, // состояние изменилось
		...
		{14, "осмотреться", "ты в своей комнате, на столе: конспекты, можно пройти - коридор"}, // состояние изменилось
		{15, "взять конспекты", "предмет добавлен в инвентарь: конспекты"},
		{16, "осмотреться", "ты в своей комнате, можно пройти - коридор"}, // состояние изменилось
		{17, "идти коридор", "ничего интересного, можно пройти - кухня, комната, улица"},
		{18, "идти кухня", "ты находишься на кухне, можно пройти - коридор"},
		{19, "осмотреться", "ты находишься на кухне, на столе: чай, надо собрать рюкзак и идти в универ, можно пройти - коридор"}, // состояние изменилось
		...
		{25, "идти улица", "на улице весна, можно пройти - коридор"},
	},
}
...
func TestGame0(t *testing.T) {
	for caseNum, commands := range game0cases {
		...
		for _, item := range commands {
			...
			fmt.Println(item.command, answer)
